...
public class ETL {
	...
	public void testEES() {
		try {
			KettleEnvironment.init();
			String jsonStr = "{\"name\":\"1\",\"user_id\":\"1\",\"type\":\"POSTGRESQL\",\"hostname\":\"127.0.0.1\",\"port\":\"5432\",\"databasename\":\"ltmap\",\"username\":\"postgres\",\"password\":\"123456\",\"table\":\"station\",\"entity_id\":\"t_2c449459c38f4c179e1d35a3fa599b1a\",\"id_database\":\"1\",\"sql\":\"select * from station\"," + "\"fields\":[{\"name\":\"id\",\"entity_column_id\":\"f_8027cca271294e9781d5322cdeeb5779\"},{\"name\":\"geom\",\"entity_column_id\":\"f_641f05bf2ae44e1db2432b266438026d\"},{\"name\":\"district\",\"entity_column_id\":\"f_b5cbb4c3382c4f57b674903fc104ad76\"},{\"name\":\"name\",\"entity_column_id\":\"f_7b8d02ee6af34351882a26a1aeb634ed\"},{\"name\":\"newclass\",\"entity_column_id\":\"f_fe5204e6e20047f6a19be56e76cf4e32\"}]}";
			...
			Map data = JSONUtil.parserStrToMap(jsonStr);
			// Map datas=JSONUtil.parserStrToMap(jsonStrs);
			data.put("sql", "select * from station");
			...
			if (repository.exists(transName, directory, RepositoryObjectType.TRANSFORMATION)) {
				...
				// repository.delTrans(new LongObjectId(1));
			...
			repository.save(transMeta, "test");
	...
	public void testCSVES() {
		try {
			KettleEnvironment.init();
			String jsonStr = "{\"name\":\"1\",\"type\":\"POSTGRESQL\",\"hostname\":\"127.0.0.1\",\"port\":\"5432\",\"databasename\":\"ltmap\",\"username\":\"postgres\",\"password\":\"123456\",\"table\":\"bar_a1_03\",\"entity_id\":\"t_e0aaf3e13561477fba9fa1a7ab3dbd13\",\"id_database\":\"1\",\"sql\":\"select * from bar_a1_03\"," + "\"fields\":[{\"name\":\"id\",\"entity_id\":\"f_eac3a58b465b40099bf994d1cf441c89\"},{\"name\":\"geom\",\"entity_id\":\"f_e58f237e43fd44e9b4b7f3e2fc931b8a\"},{\"name\":\"name\",\"entity_id\":\"f_269997a9f0bc419e8d38dee2b047da14\"},{\"name\":\"data\",\"entity_id\":\"f_f2b79396292c4fc49fb070609030760e\"}]}";
			jsonStr = "{\"name\":\"1\",\"type\":\"POSTGRESQL\",\"hostname\":\"127.0.0.1\",\"port\":\"5432\",\"databasename\":\"ltmap\",\"username\":\"postgres\",\"password\":\"123456\",\"table\":\"camera\",\"entity_id\":\"t_058426787f8f4a3aac57f3a0233571b6\",\"id_database\":\"1\",\"sql\":\"select * from camera\"," + "\"fields\":[{\"name\":\"id\",\"entity_id\":\"f_ef29cfe8e5ce4b1d805ee349f281045e\"},{\"name\":\"x\",\"entity_id\":\"f_6d5503c78dac4ffc97e097b34f29cddd\"},{\"name\":\"geom\",\"entity_id\":\"f_37a5bc724eca44b787ba9648ca922bfd\"},{\"name\":\"y\",\"entity_id\":\"f_318e74aa50364036bb0f6d0463ce2d30\"}]}";
			// String jsonStr ="{\"name\":\"127.0.0.1\",\"type\":\"POSTGRESQL\",\"hostname\":\"127.0.0.1\",\"port\":\"5432\",\"databasename\":\"ltmap\",\"username\":\"postgres\",\"password\":\"123456\",\"table\":\"test_f\",\"entity_id\":\"t_49f92fda2492423c84c81d4bab9a2733\",\"id_database\":\"1\",\"sql\":\"select * from test_f\",\"fields\":[{\"name\":\"id\",\"entity_id\":\"f_61b22c416bc2491b8c81ec86002de615\"},{\"name\":\"test_fname\",\"entity_id\":\"f_060bc2d1d8be4f458e10884a4c94e805\"},{\"name\":\"test_p_id\",\"entity_id\":\"f_6a820b0829f043dc9b671af80907958a\"}]}";
			// String jsonStr ="{\"name\":\"10.211.55.7\",\"type\":\"MYSQL\",\"hostname\":\"10.211.55.7\",\"port\":\"3306\",\"databasename\":\"kettle\",\"username\":\"root\",\"password\":\"mysql\",\"fields\":[{\"name\":\"f1\",\"entity_id\":\"123456\"},{\"name\":\"f2\",\"entity_id\":\"654321\"}]}";
			// String jsonStrs ="{\"name\":\"10.211.55.7\",\"type\":\"POSTGRESQL\",\"hostname\":\"10.211.55.7\",\"port\":\"5432\",\"databasename\":\"ltmap\",\"username\":\"postgres\",\"password\":\"123456\"}";
			Map data = JSONUtil.parserStrToMap(jsonStr);
