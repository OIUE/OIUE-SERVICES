    ...
    public void start() throws Exception {
        this.start(new MulitServiceTrackerCustomizer() {
            ...
            public void addingService() {
                ...
                driverListener = new DriverListenerStorageServiceImpl(logService, iResource, analyzerService);
        ...
        }, LogService.class, IResource.class, AnalyzerService.class, DriverListenerService.class);
    }
