...
public class HttpClientServiceImpl implements HttpClientService {
    ...
    @Override
    public Map httpDownload(String url, Map<String, String> para, String path) throws UnsupportedEncodingException, IOException {
    ...
    @Override
    public Map<?, ?> getGetData(String url, Map<String, String> para) throws UnsupportedEncodingException, IOException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        Map returnMap = new HashMap();
        try {
    ...
    @Override
    public Map<?, ?> getPostData(String url, String str) throws UnsupportedEncodingException, IOException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        Map returnMap = new HashMap();
        try {
            HttpPost httppost = new HttpPost(url);
    ...
    @Override
    public Map<?, ?> getPostDataByJson(String url, String str) throws UnsupportedEncodingException, IOException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
